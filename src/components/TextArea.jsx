...
<div className="mb-3 my-3">
    <h2 style={{color:`${props.mode ==="light" ?"black" :"#b3edff"}`}}>Text Utility</h2>
  <textarea className={`form-control ${props.mode === "light" ? "placeHolder-light" : "placeHolder-dark"}`} id="textArea" rows="8" value={text} placeholder="Enter text here" onChange={handleTextOnChange} style={{backgroundColor:`${props.mode ==="light" ?"white" :"#222020"}` , color:`${props.mode ==="light" ?"black" :"white"}`}}></textarea>
</div>

<button className="btn btn-primary"  onClick={handleOnUpperCase}>To UpperCase</button>

<button className="btn btn-primary mx-2"  onClick={handleOnLowerCase}>To LowerCase</button>
...
<div className="mb-3 my-2" style={{color:`${props.mode ==="light" ?"black" :"#b3edff"}`}}>
    <h2>Text Summary</h2>
    ...
    { text ? 
<button className="btn btn-primary mx-2"  onClick={handleOnCopyText}>Copy Text</button> :""}
</div>
    </>
  );
};
